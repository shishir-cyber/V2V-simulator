...
Objectives :
	...
	Study the impact of:
		...
		> Network density
		> Interference zones
	Provide real-time visualization of routing behaviour.
...
Key Concepts :
	...
	Routing Algorithm :
    	...
    	> Finds the shortest path (minimum distance)
...
System Architecture :
	The system is divided into the following layers:
		...
		> Visualization Layer → Displays real-time simulation
...
Getting Started
	1. Clone the Repository
		> git clone https://github.com/your-username/v2v-routing-simulation.git
...
How It Works :
	...
	> Interference zones disrupt paths → triggering rerouting
